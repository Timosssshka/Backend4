...
<!--             <input type="text" name="birth_year" id="birth_year" value="<?= getFieldValue('birth_year') ?>"> -->
            ...
            <label>Пол:</label>
            <?= showError('gender') ?>
            <label><input type="radio" checked="checked" name="gender" value="male" <?= getChecked('sex', 'male') ?> />Мужской</label>
			<label><input type="radio" name="gender" value="female" <?= getChecked('sex', 'female') ?> />Женский</label>

            <label>Количество конечностей:</label>
            <?= showError('limbs') ?>
            <label><input type="radio" name="limbs" value="2" <?=getSelected('limbs', '2')?>> 2</label>
           <label><input type="radio" name="limbs" value="2" <?=getSelected('limbs', '4')?>> 4</label>
